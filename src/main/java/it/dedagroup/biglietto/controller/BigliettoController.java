...
public class BigliettoController {
    ...
    @ApiResponses(value = {
    	       ...
    	       @ApiResponse(responseCode = "400", description = "Errato inserimento del JSON", content = @Content(mediaType = MediaType.ALL_VALUE))
    	})
    @PostMapping(INSERT_BIGLIETTO_PATH)
    public ResponseEntity<Biglietto> saveBiglietto(BigliettoDTORequest biglietto){
    ...
    public ResponseEntity<Biglietto> modifyBiglietto(BigliettoDTORequest biglietto){
    ...
    @ApiResponses(value = {
    	       ...
    	       @ApiResponse(responseCode = "400", description = "Errato inserimento del PathVariable", content = @Content(mediaType = MediaType.ALL_VALUE))
    	})
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Biglietto non trovato", content = @Content(mediaType = MediaType.ALL_VALUE))
				})
    ...
    @Operation(summary = "metodo per cercare un Biglietto tramite l'Utente", description = "In questo EndPoint cerchiamo il biglietto tramite L'ID inserito nel "
			+ "PathVariable, per poi ritornare l'oggetto selezionato tramite repository")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Biglietto trovato tramite ID e appartenente all'utente con ID selezionato", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = BigliettoDTORequest.class))),
			@ApiResponse(responseCode = "400", description = "Biglietto non trovato", content = @Content(mediaType = MediaType.ALL_VALUE))
				})
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Lista di biglietti non trovata tramite prezzo superiore", content = @Content(mediaType = MediaType.ALL_VALUE))
				})
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Lista di biglietti non trovata tramite prezzo inferiore", content = @Content(mediaType = MediaType.ALL_VALUE))
				})
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Lista di biglietti non trovata tramite l'ID Utente inserito", content = @Content(mediaType = MediaType.ALL_VALUE))
				})
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Lista di biglietti non trovata tramite la data di acquisto inserita", content = @Content(mediaType = MediaType.ALL_VALUE))
				})
